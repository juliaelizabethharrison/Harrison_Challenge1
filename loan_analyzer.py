...
Present_value_nueva_loan = present_value(new_loan.get("future_value"),new_loan.get("remaining_months"), 0.2)



# @TODO: Use the function to calculate the present value of the new loan given below.
print(f"The present value of the loan is: {Present_value_nueva_loan}")
...
for loan in loans:
    if loan.get("loan_price")<=500:inexpensive_loans.append(loan)
